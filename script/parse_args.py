...
def parse_args():
    ...
    parser.add_argument('--name', type=str, help='DS name', 
                        choices=['Aachen', 'Aachen_real', 'Aachen_day', 'Aachen_night', 'Aachen_real_und', 'Aachen_small', 
                                ...
                                'inTraj', 'outTraj', 'Synthesis', 'Swiss_in', 'Swiss_out', 'Video'], default='inTraj')
    ...
    parser.add_argument('--pose_prior', type=str, help='start from a pose prior in this file', default='output/in_new2/new_w2c_output.txt')
    ...
    # Pretrain model
    parser.add_argument("--pretrain", type=str, default='./ckpt/Depthv2_maskTrain3.ckpt', help='model path')

    # DepthV2 base model
    parser.add_argument("--encoder", type=str, default='vitb', help='[vits, vitb, vitl]')

    # Render Config
    parser.add_argument("--render_config", type=str, default='./config/config_RealTime_render_1.json', help='Render Config')

...
def get_paths(base_path, colmap_res, mesh_type):
    ...
    # UAVD4L-LoD
    UAVD4L_LoD = ['inTraj', 'outTraj', 'Synthesis', 'Swiss_in', 'Swiss_out', 'Video']
    for sc in UAVD4L_LoD:
        paths_conf[sc] = {
            'root': f'{base_path}/UAVD4L-LoD/{sc}',
            'colmap': f'{base_path}/all_colmaps/UAVD4L-LoD/{sc}/colmap_{colmap_res}',
            'q_file': f'{base_path}/UAVD4L-LoD/{sc}/dataset_test.txt',
            'db_file': f'{base_path}/UAVD4L-LoD/{sc}/dataset_train.txt',
            'mesh_path': NotImplemented,
            'ns_config': NotImplemented,
            'ns_transform': NotImplemented,
            'gaussians': NotImplemented,
        }
